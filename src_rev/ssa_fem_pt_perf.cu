...
#define BLOCK_Xe  1024   //optimal block size for e7s
...
int main(){
    ...
    // const char* inputfile  = "../inputfiles/PIG7e4.bin";
    // const char* inputfile  = "../inputfiles/PIG1e5.bin";
    // const char* inputfile  = "../inputfiles/PIG2e6.bin";

    // const char* inputfile  = "../inputfiles/JKS2e4.bin";
    // const char* inputfile  = "../inputfiles/JKS8e4.bin";
    // const char* inputfile  = "../inputfiles/JKS3e5.bin";
    const char* inputfile  = "../inputfiles/JKS1e6.bin";
