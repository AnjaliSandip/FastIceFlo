...
/*CUDA Code*/
__global__ void PT1(double* vx, double* vy, double* alpha, double* alpha_0, double* alpha_1, double* alpha_2, int nbe){ 
...
//////////////////////////////////////////////////
    ...
    for(iter=1;iter<=niter;iter++){
        ...
        PT1<<<gride, blocke>>>(d_vx, d_vy, d_alpha, d_alpha_0, d_alpha_1, d_alpha_2, nbe);
