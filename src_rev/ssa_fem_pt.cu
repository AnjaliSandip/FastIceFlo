...
#define BLOCK_Xe  512   //optimal block size for JKS2e4 and PIG3e4
#define BLOCK_Xv  512 
...
int main(){
    ...
    const char* inputfile  = "./PIG5e5.bin";
    ...
    /*Constants*/
    double n_glen     = 3.;
    double damp       = 0.995; //0.96 for JKS2e4, 0.981 for PIG3e4
    ...
    double relaxation = 0.999; //0.7 for JKS2e4, 0.967 for PIG3e4
